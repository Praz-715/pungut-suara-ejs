...
function init_bar_bar() {
	console.log('sesi',sessionStorage.getItem('sidebar'))
	if (sessionStorage.getItem('sidebar') == null) {
		sessionStorage.setItem('sidebar', 'keluar')
	} else {
		if (sessionStorage.getItem('sidebar') === 'keluar') {
			// document.getElementsByTagName('body').className = 'nav-sm'
			$SIDEBAR_MENU.find('li.active ul').hide();
			$SIDEBAR_MENU.find('li.active').addClass('active-sm').removeClass('active');
		} else if(sessionStorage.getItem('sidebar')=== 'kedalam'){
			// document.getElementsByTagName('body').className = 'nav-md'
			$SIDEBAR_MENU.find('li.active-sm ul').show();
			$SIDEBAR_MENU.find('li.active-sm').addClass('active').removeClass('active-sm');
			$BODY.toggleClass('nav-md nav-sm');
		}
